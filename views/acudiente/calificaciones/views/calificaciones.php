<div class="col-lg-10 col-md-9 containerSection">
    ...
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-4 text-center mt-2">
            ...
            <button type="button" class="btn w-75" id="btnDefinitivaAño" style="display: none;" data-bs-toggle="modal" data-bs-target="#ModalDefinitivaAño">
                <i class="bi bi-pencil-square"></i> Definitiva Año
            </button>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4 text-center mt-2">
            <!-- Boton del modal definitiva -->
            <button type="button" class="btn w-75" id="btnDefinitiva" style="display: none;" data-bs-toggle="modal" data-bs-target="#ModalDefinitiva">
                ...
                <form id="formDefinitiva" action="/proyecto/views/docente/calificaciones/index.php" method="POST">
                    <div class="row justify-content-center" id="CamposDesempeño">
                        ...
                        <div class="col-12 mt-2">
                            ...
                            <select class="form-control" name="desempeñoDefinitiva" id="desempeñoDefinitiva" disabled>
...
<script>
    ...
    $('#ModalPorcentaje').on('click', function(){
        const IdMateria = $('#Listamaterias').val()
                ...
                result.map((DatosPorcentajes,index)=>{
                    ...
                    html = `
                        <div class="col-12 mt-2">
                            ...
                            <input type="text" class="form-control" name="tareas" id="tareas" value="${Tareas}" maxlength="4"  onKeypress="VerificacionNumeros()" disabled>
                        </div>
                        <div class="col-12 mt-2">
                            <label style="color: rgb(0, 3, 44);" for="talleres" class="text-start">&nbsp;Talleres: </label>
                            <input type="text" name="talleres" id="talleres" class="form-control" value="${Talleres}" maxlength="4" onKeypress="VerificacionNumeros()"  disabled>
                        </div>
                        <div class="col-12 mt-2">
                            <label style="color: rgb(0, 3, 44);" for="evaluaciones" class="text-start">&nbsp;Evaluaciones: </label>
                            <input type="text" name="evaluaciones" id="evaluaciones" class="form-control" value="${Evaluaciones}" maxlength="4" onKeypress="VerificacionNumeros()"  disabled>
                        </div>
                    `
    ...
    $('#Listamaterias').change(function(){
        ...
        periodo = $('#periodo').val()
        console.log(grado,materia,estudiante,periodo);
        // return false;
    ...
    $('#btnDefinitiva').on('click', function(){
        ...
        IdMateria = $('#Listamaterias').val()
        Periodo = $('#periodo').val()
        IdEstudiante = $('#listaEstudiantes').val()
        switch(IdGrado){
            case '1':
                grado = 'Prescolar'
            break;
